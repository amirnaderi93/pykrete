...
/// `receiver_is_pandas_inherited`. Verified at v1.8 PR-A1 against
/// `operations/expr.rs` lines 893 (head/tail/first/take pass-through),
/// 1090 (rename), 1101 (assign), 1118 (drop columns kwarg), 1137
/// (drop positional), 1153 (pivot_table), 1180 (melt). Hand list kept
/// as a redundant tripwire vs the build-script-generated const; if
/// they disagree, `v18_pr_a1_hand_inventory_matches_generated` fails.
